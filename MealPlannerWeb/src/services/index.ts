...
export { householdMemberService } from './householdMembers';
export { pantryService } from './pantry';
export { feedbackService } from './feedback';
export { shoppingService } from './shopping';
export { userPreferencesService } from './userPreferences';
export { pricingService } from './pricing';
export { instacartService } from './instacart';
...
export interface MealPlanService {
  generateWeeklyPlan(userProfile: UserProfile, options?: {
